...
rm $(pwd)/$0 &> /dev/null
source <(curl -sL https://raw.githubusercontent.com/NDsVPN/ChumoGH-Script/main/msg-bar/msg)
fun_ip () {
...
wget -O /bin/trans -q https://raw.githubusercontent.com/NDsVPN/chumogh-gmail.com/main/trans && chmod +x /bin/trans
