#!/bin/bash
 ...
 module="$(pwd)/module"
 rm -rf ${module}
 wget -O ${module} "https://raw.githubusercontent.com/NDsVPN/Herramientas/main/module/module" &>/dev/null
 [[ ! -e ${module} ]] && exit
 ...
 repo(){
   link="https://raw.githubusercontent.com/NDsVPN/ADMRufu/main/Repositorios/$1.list"
   case $1 in
 ...
 function_verify () {
   ...
   ver=$(curl -sSL "https://raw.githubusercontent.com/NDsVPN/ADMRufu/main/vercion")
 ...
 post_reboot(){
   echo 'wget -O /root/install.sh "https://raw.githubusercontent.com/NDsVPN/ADMRufu/main/install.sh"; clear; sleep 2; chmod +x /root/install.sh; /root/install.sh --continue' >> /root/.bashrc
